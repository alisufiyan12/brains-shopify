      ...
      <div>
        <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
          <div className="flex flex-col justify-center">
            {/* 
  */}
            <Image className='rounded-md' src={thumb} width={thumbWidth} height={thumbHeight} alt={thumbAlt} />
                <FaPlay className='absolute left-50 top-50 flex items-center transform -translate-y-1/2 bg-white rounded-full font-medium group p-4 shadow-lg' />
          ...
          <button className="absolute top-full flex items-center transform -translate-y-1/2 bg-white rounded-full font-medium group p-4 shadow-lg" onClick={() => { setModalOpen(true) }}>
            ...
            <span id="headd" className="ml-3">Watch instructors message (2 min)</span>
          </button>
        </div>
      </div>
      {/* End: Video thumbnail */}
